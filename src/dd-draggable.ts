...
export class DDDraggable extends DDBaseImplement implements HTMLElementExtendOpt<DDDragOpt> {
  ...
  protected _mouseUp(e: MouseEvent): void {
    ...
    if (isTouch) {
      // The below change was made to fix the following issue: https://github.com/homarr-labs/homarr/issues/2028
      // It was tested with a patch first before publishing the fix. (added question mark)
